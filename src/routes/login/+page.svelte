...
<div class="min-h-screen bg-base-100 flex flex-col items-center justify-center p-4">
	<div class="w-full max-w-md">
		<div class="flex flex-col items-center mb-10">
			...
			<h1 class="text-3xl font-serif italic">Welcome back</h1>
			<p class="text-base-content/60 mt-2">Sign in to continue your rituals.</p>
		</div>
		...
		<div class="card bg-base-200 shadow-xl rounded-3xl overflow-hidden">
			<div class="card-body p-8">
				...
				<form onsubmit={(e) => { e.preventDefault(); signIn(); }} class="space-y-5">
					...
					<div class="form-control">
						<div class="flex justify-between items-center pb-2">
							<label class="label pt-0 pb-0" for="password">
								<span class="label-text font-bold text-xs uppercase tracking-widest opacity-60">Password</span>
							</label>
							<a href="/forgot-password" class="text-xs link link-primary no-underline hover:underline font-medium">Forgot?</a>
						</div>
						<input
							type="password"
							id="password"
				...
				<p class="text-center text-sm text-base-content/60">
					...
					<a href="/register" class="link link-primary font-bold no-underline hover:underline">Sign Up</a>
				</p>
			</div>
		</div>
